...
var Drag = function (_React$Component) {
  ...
  function Drag(props) {
    ...
    _this.handleDragStart = function (e, data) {
      ...
      if (e.target.parentNode === _this.dragWarp) {
    ...
    _this.handleDragEnter = function (e) {
      ...
      if (e.target === _this.dropWarp) {
        console.log('进入目标容器');

        _this.dragEnterData = _this.dragStartData;

        e.target.addEventListener('dragleave', _this.handleOnDragLeave);
      } else if (e.target === _this.dragWarp) {
        console.log('返回原来容器');
        _this.dragEnterData = {};
      } else if (_this.dropList && e.target.parentNode.getAttribute('dropItem') === _this.dropList.getAttribute('dropItem')) {
        if (list.filter(function (item) {
          return item.id === iddd;
        }).length === 0) {
          list.push(_this.dragStartData);
          _this.setState({
    ...
    _this.buildListShow = function (params) {
      var _this$state$list3 = _this.state.list,
          list = _this$state$list3 === undefined ? [] : _this$state$list3;
      var id = params.id,
          i = params.i,
          type = params.type;
      ...
      return _react2.default.createElement(
        ...
        Object.keys(Option).map(function (item, i) {
          return item === 'dragWarp' ? _react2.default.createElement(
            'div',
            {
              className: (0, _classnames2.default)('drag-warp', dragClassName),
              style: dragStyle,
              key: i,
              ref: function ref(drag) {
                return _this3.dragWarp = drag;
              }
            },
            ...
            'div',
            {
              ...
              ref: function ref(drop) {
                return _this3.dropWarp = drop;
              }
            },
